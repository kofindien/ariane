   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- TemplateBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
              <div id="debut" style="display:block;">
                <div style="float:left; width:46%; text-indent:0.5px;"> NAVETTE Plus est un service original qui vise à contribuer à résoudre le problème du transport en Abidjan. C'est un service de navette partagée qui reliera, lorsqu'il sera pleinement opérationnel, les quartiers des communes de Cocody, Treichville et Marcory au Plateau.<br />
                  <br />
                  ...
                  <br />
                  Dans un premier temps, le service sera effectué dans une phase expérimentale qui reliera Les 2 Plateaux/Angré au Plateau, selon un parcours qui comprend plusieurs têtes de navette. </div>
                <div style="float:right; width:46%; text-indent:0.5px; padding-right:20px;"> Les têtes de navettes sont des points de départ de navettes vides afin de permettre aux personnes se trouvant tout au long du parcours de disposer d'une place dans les véhicules.<br />
                  <br />
                  Les navettes sont constituées de véhicules neufs, avec climatisation d'origine, et régulièrement entretenus par les concessionnaires qui les ont livrés. Ce qui les rend confortables et fiables.<br />
                  <br />
                  <div align="right"> <img src="../images/puce1.gif" width="14" height="5" /> <a href="javascript:divHideShow('debut/suite');" class="nav">Lire la suite</a> </div>
                  <div style="margin:20px; border-radius:5px;">
                    <div align="center" style="padding:10px;">
                      <input name="abonnement" type="button" class="btn btn-primary" id="abonnement" value="Cliquez pour vous abonner !" />
                    </div>
                  </div>
                </div>
              </div>
              <div id="suite" style="display:none;">
                <div style="float:left; width:46%; text-indent:0.5px;"> Nous vous invitons à vous familiariser avec les conditions de fourniture de ce nouveau service en consultant les autres pages de notre site.<br />
                  <br />
                  Les navettes sont également rapides. Dès qu'une navette affiche complet, elle se rend directement à sa destination déclarée.<br />
                  <br />
                  Les tarifs des services sont présentés à la page <a href="tarifs-navette-plus" class="bleulien">Tarifs</a> de notre site. Ils sont compétitifs et adaptés au service fourni.<br />
                  <br />
                  L'accès au service se fait contre paiement d'un ticket papier, d'un ticket électronique ou au moyen d'une carte pré-payée rechargeable. </div>
                <div style="float:right; width:46%; text-indent:0.5px; padding-right:20px;"> Toutefois, en attendant la mise au point des moyens de paiement électroniques et par carte pré-payée, les tickets seront achetés à bord des navettes auprès des conducteurs.<br />
                  <br />
                  Il est à noter que la monnaie exacte est exigée pour le paiement des tickets.<br />
                  <br />
                  Aucune monnaie ne sera rendue pour les paiements supérieurs au prix du ticket.<br />
                  <br />
                  <div align="right"> <img src="../images/puce1.gif" width="14" height="5" /> <a href="javascript:divHideShow('suite/debut');" class="nav">Précédent</a> </div>
                  <div style="margin:20px; border-radius:5px;">
                    <div align="center" style="padding:10px;">
                      <input name="abonnement" type="button" class="btn btn-primary" id="abonnement" value="Cliquez pour vous abonner !" />
                    </div>
