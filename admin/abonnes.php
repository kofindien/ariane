...
$queryOperations = "SELECT * FROM clients WHERE clients.suppr = 0";
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations = "SELECT clients.idcl, clients.civilite, clients.nom, clients.prenoms, clients.cel, clients.email, clients.dateaj FROM clients WHERE clients.suppr = 0 ORDER BY clients.idcl DESC";
...
<div class="pull-left titre">Les abonnés</div>
...
<table class="table table-striped table-hover" width="100%" border="0" cellspacing="1" cellpadding="2">
              ...
              <?php do { ?>
                  <tr>
                    <td><a href="vueabonne.php?id=<?php echo $row_rsOperations['idcl']; ?>"><?php LongDateEN2dateFR($row_rsOperations['dateaj']); ?></a></td>
                    <td><?php echo stripslashes($row_rsOperations['nom']); ?></td>
            ...
            <div style="margin-bottom:70px;">
                <?php
                    ...
                    echo paginate('abonnes.php', '?page=', $totalPages_rsOperations, $current);
                ?>          
        </div>
      </div>
      </div>
