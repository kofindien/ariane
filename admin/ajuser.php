...
<title>Ajouter un utilisateur ::: Console d'administration</title>
<!-- InstanceEndEditable -->
...
$(document).ready(function(){
	...
	$("#Submit").click(function(){
		...
		if (nom =="" || prenoms =="" || cel =="" || idg =="" || email =="" || motpasse ==""){
		...
		$.post('insertcompte.php', {nom: nom, prenoms: prenoms, cel: cel, idg: idg, email: email, motpasse: motpasse},
		function(data){
			$("#message").html(data);
			$("#message").hide();
			$("#flash").hide();
...
<div class="pull-left titre">Ajouter un utilisateur</div>
</div>
...
<form method="post" class="form-horizontal" id="frmCompte" name="frmCompte">
...
<div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="input-prepend">
      ...
      <input name="cel" type="text" required="required" class="input-small" id="cel" placeholder="00000000" maxlength="8">
    </div>
    </div>
  </div>
...
<div class="control-group">
  <label class="control-label" for="idg">Groupe d'utilsateur <span class="rouge">*</span></label>
    ...
    <select name="idg" class="input-large" id="idg">
      ...
      <?php do { ?>
      <option value="<?php echo $row_rsGroupe['idg']?>"><?php echo $row_rsGroupe['libg']?></option>
      <?php
  ...
  <div class="control-group">
    <div class="controls">
      ...
      <button type="submit" id="Submit" name="Submit" class="btn btn-primary"><i class="icon-check icon-white"></i> Créer le compte</button>
    </div>
  </div>
</form>
