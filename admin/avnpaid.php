...
mysql_select_db($database_liaisondb, $liaisondb);
$queryOperations = "SELECT * FROM alerts_voyages WHERE alerts_voyages.statut = '2' ORDER BY alerts_voyages.id DESC";
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations ="SELECT * FROM alerts_voyages WHERE alerts_voyages.statut = '2' ORDER BY alerts_voyages.id DESC";
