...
$queryOperations = "SELECT * FROM compagnies WHERE compagnies.sup = 0";
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations = "SELECT * FROM compagnies WHERE compagnies.sup = 0 ORDER BY compagnies.compagnie";
...
<title>Les compagnies aériennes ::: Console d'administration</title>
<!-- InstanceEndEditable -->
...
<div class="pull-left titre">Les compagnies aériennes</div>
...
<tbody>
  ...
  <?php do { ?>
  <tr>
    <td width="90%"><?php echo stripslashes($row_rsOperations['compagnie']); ?></td>
    <td width="10%">
    <div class="btn-group btn-small">
    <a class="btn btn-small btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
     Traitements <span class="caret"></span> </a>
      <ul class="dropdown-menu">
        <li> <a tabindex="-1" href="majcompagnie.php?id=<?php echo $row_rsOperations['idcp']; ?>">
         <i class="icon-edit"></i> Modifier</a> </li>
        <li><a tabindex="-1" href="compagnies.php?id=<?php echo $row_rsOperations['idcp']; ?>&action=supprimer"> 
...
<div style="margin-bottom:70px;">
              <?php
                    ...
                    echo paginate('compagnies.php', '?page=', $totalPages_rsOperations, $current);
                ?>          
        </div>
      </div>
      </div>
