...
$queryOperations = "SELECT * FROM departs WHERE departs.sup = 0";
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations = "SELECT * FROM departs WHERE departs.sup = 0 ORDER BY departs.ddate DESC";
...
<title>Les dates de départ ::: Console d'administration</title>
<!-- InstanceEndEditable -->
...
<div class="pull-left titre">Les dates de départ</div>
...
<tbody>
  ...
  <?php do { ?>
  <tr>
    <td width="90%"><?php echo dateEN2dateFR($row_rsOperations['ddate']); ?></td>
    <td width="10%">
    <div class="btn-group btn-small">
    <a class="btn btn-small btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
     Traitements <span class="caret"></span> </a>
      <ul class="dropdown-menu">
        <li> <a tabindex="-1" href="majpays.php?id=<?php echo $row_rsOperations['iddpt']; ?>">
         <i class="icon-edit"></i> Modifier</a> </li>
        <li><a tabindex="-1" href="pays.php?id=<?php echo $row_rsOperations['iddpt']; ?>&action=supprimer"> 
...
<div style="margin-bottom:70px;">
              <?php
                    ...
                    echo paginate('pays.php', '?page=', $totalPages_rsOperations, $current);
                ?>          
        </div>
      </div>
      </div>
