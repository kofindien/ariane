...
$queryOperations = "SELECT * FROM horaires WHERE horaires.sup = 0";
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations = "SELECT * FROM horaires WHERE horaires.sup = 0 ORDER BY horaires.heure";
...
<title>Les horaires ::: Console d'administration</title>
<!-- InstanceEndEditable -->
...
<div class="pull-left titre">Les horaires</div>
...
<tbody>
  ...
  <?php do { ?>
  <tr>
    <td width="90%"><?php echo $row_rsOperations['heure']; ?></td>
    <td width="10%">
    <div class="btn-group btn-small">
    <a class="btn btn-small btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
     Traitements <span class="caret"></span> </a>
      <ul class="dropdown-menu">
        <li> <a tabindex="-1" href="majpays.php?id=<?php echo $row_rsOperations['idh']; ?>">
         <i class="icon-edit"></i> Modifier</a> </li>
        <li><a tabindex="-1" href="pays.php?id=<?php echo $row_rsOperations['idh']; ?>&action=supprimer"> 
