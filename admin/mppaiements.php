...
$query_rsTotaux = "SELECT SUM(mprofil.montant) AS preleve, SUM(mprofil.cout) AS coutserv, SUM(mprofil.fraisp) AS plateforme FROM mprofil WHERE mprofil.status=1";
...
mysql_select_db($database_liaisondb, $liaisondb);
$queryOperations = "SELECT * FROM mprofil WHERE mprofil.sup = 0 AND mprofil.status = 1";
