...
$queryOperations = "SELECT * FROM numvols WHERE numvols.sup = 0";
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations = "SELECT numvols.idnv, numvols.numero, compagnies.compagnie FROM numvols, compagnies WHERE numvols.idcp = compagnies.idcp AND numvols.sup = 0 ORDER BY numvols.numero";
...
<title>Les numéros de vols ::: Console d'administration</title>
<!-- InstanceEndEditable -->
...
<div class="pull-left titre">Les numéros de vols</div>
...
<thead>
  <tr>
    ...
    <th width="30%">Compagnie aérienne</th>
    <th width="10%">&nbsp;</th>
  </tr>
</thead>
<tbody>
  ...
  <?php do { ?>
  <tr>
    <td width="60%"><?php echo stripslashes($row_rsOperations['numero']); ?></td>
    <td width="30%"><?php echo stripslashes($row_rsOperations['compagnie']); ?></td>
    <td width="10%">
    <div class="btn-group btn-small">
    <a class="btn btn-small btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
     Traitements <span class="caret"></span> </a>
      <ul class="dropdown-menu">
        <li> <a tabindex="-1" href="majpays.php?id=<?php echo $row_rsOperations['idnv']; ?>">
         <i class="icon-edit"></i> Modifier</a> </li>
        <li><a tabindex="-1" href="pays.php?id=<?php echo $row_rsOperations['idnv']; ?>&action=supprimer"> 
...
<div style="margin-bottom:70px;">
              <?php
                    ...
                    echo paginate('numvols.php', '?page=', $totalPages_rsOperations, $current);
                ?>          
        </div>
      </div>
      </div>
