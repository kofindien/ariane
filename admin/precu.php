...
mysql_select_db($database_liaisondb, $liaisondb);
 $query_rsOperation = sprintf("SELECT mprofil.idp, mprofil.idab, mprofil.montant, mprofil.cout, mprofil.fraisp, mprofil.mpaie, mprofil.mensualite, mprofil.fdate, mprofil.ddate, mprofil.mensualite, mprofil.dateaj, mprofil.status, mprofil.dateserv, services.service, abonnements.niveau, abonnements.diplome, abonnements.experience, abonnements.age, domaines.domaine FROM mprofil, abonnements, services, domaines WHERE mprofil.idab = abonnements.idab AND abonnements.ids = services.ids AND abonnements.idd = domaines.idd AND mprofil.status = 1 AND mprofil.idp = %s", GetSQLValueString($colname_rsOperation, "int"));
...
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(20, 5, 'Mon Profil', 0, 1, 'L');
$pdf->Ln(10);
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Domaine', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.$row_rsOperation['domaine'], 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Niveau ', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.$row_rsOperation['niveau'], 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Diplôme ', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.$row_rsOperation['diplome'], 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Expérience ', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.$row_rsOperation['experience'].' an(s)', 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Age', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.$row_rsOperation['age'].' ans', 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
...
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Durée ', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.$row_rsOperation['mensualite'].' mois', 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Début ', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.date("d/m/Y", strtotime($row_rsOperation['ddate'])), 1, 1, 'L');
$pdf->SetFont('helvetica', 'B', 10);
$pdf->Cell(50, 5, 'Fin ', 1, 0, 'L');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  '.date("d/m/Y", strtotime($row_rsOperation['fdate'])), 1, 1, 'L');
