...
mysql_select_db($database_liaisondb, $liaisondb);
 $query_rsOperation = sprintf("SELECT mprofil.idp, mprofil.idab, mprofil.montant, mprofil.cout, mprofil.fraisp, mprofil.mpaie, mprofil.mensualite, mprofil.dateaj, mprofil.status, mprofil.dateserv, services.service, abonnements.niveau, abonnements.diplome, abonnements.experience, abonnements.age, domaines.domaine FROM mprofil, abonnements, services, domaines WHERE mprofil.idab = abonnements.idab AND abonnements.ids = services.ids AND abonnements.idd = domaines.idd AND mprofil.status = 0 AND mprofil.idp = %s", GetSQLValueString($colname_rsOperation, "int"));
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->Image("../img/attente.png", 0, 0, 0, 0, '', '', '', false, 300, '', false, false, 0);
...
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(80, 5, '  En attente', 1, 1, 'L');
