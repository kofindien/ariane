...
<table class="table table-striped table-hover" width="100%" border="0" cellspacing="1" cellpadding="2">
              ...
              <?php do { ?>
                  <tr>
                    ...
                    <td><a href="majuser.php?id=<?php echo $row_rsUsers['idc']; ?>" class="lien_bleu_"><i class="icon-edit"></i> modifier</a></td>
                  </tr>
            ...
            <div style="margin-bottom:70px;">
                <?php
                    ...
                    echo paginate('users.php', '?page=', $totalPages_rsUsers, $current);
                ?>          
        </div>
