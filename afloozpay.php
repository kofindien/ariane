...
<form action="afloozpay1.php" method="post" name="frmRecharge" class="form-horizontal" id="frmRecharge">
...
<div class="control-group">
  <label class="control-label" for="cout">Coût du service</label>
    ...
    <div class="input-append">
      <input type="text" id="cout" name="cout" class="input-small" style="text-align:right" value="2000" readonly="readonly">
  ...
  <div id="idfom" class="control-group">
    ...
    <div class="controls">
    <div class="input-append">
      <input type="text" id="fraisp" name="fraisp" class="input-small" readonly="readonly" style="text-align:right" value="309">
      <span class="add-on">F CFA</span>
    </div>
    </div>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="input-append">
      <input type="text" id="montant" name="montant" class="input-small" readonly="readonly" style="font-weight:bold; color:#F00; text-align:right;" value="2309">
      <span class="add-on">F CFA</span>
    </div>
    </div>
  </div>
