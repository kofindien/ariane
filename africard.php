...
<title>VISA Africard - Présentation ::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="filariane" style="margin-bottom:20px; padding:10px 0;">Carte Prépayée VISA Africard / Présentation </div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
               <img src="img/africard.jpg" /><br /><br /> 
                ...
                <div class="accordion" id="accordion2">
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Présentation</strong> </a>
                    </div>
                    <div id="collapse1" class="accordion-body collapse in">
                      <div class="accordion-inner">
                        La carte  prépayée VISA Africard est une carte de retrait rechargeable qui vous offre une multitude 
                        de possibilités et son coût est très abordable.<br /><br />
                        Elle n'est pas rattachée à un compte bancaire, ce qui procure flexibilité et mobilité à ses
                         utilisateurs.<br /><br />
                        La carte est utilisable dans le monde entier sur le réseau VISA.
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Les avantages</strong> </a>
                    </div>
                    <div id="collapse2" class="accordion-body collapse">
                      <div class="accordion-inner">
                        <u>Pour les particuliers :</u><br /><br />
                        <ul>
                          <li> Utilisable immédiatement : dès le rechargement dans une agence UBA ou dans les points 
                          agréés ;</li>
                          <li> Zéro frais de gestion mensuelle ;</li>
                          <li> Disponibilité immédiate des fonds, en cas de réception d'un transfert sur carte, évitant
                           ainsi les files d'attentes dans les banques ;</li>
                          <li> Sécurité : la carte évite les risques liés au transport d'espèces (par exemple lors des
                           voyages).</li>
                        </ul>
                          <u>Pour les entreprises / organisations</u> :<br /><br />
                          <ul>
                          <li>Simplification de la gestion des paiements à des tiers (paies, frais de missions, primes,
                           bourses, etc.) ;</li>
                          <li>Personnalisable selon vos besoins, la carte peut être façonnée pour servir de carte d'abonné,
                           de carte d'étudiant, etc.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Les fonctionnalités</strong> </a>
                    </div>
                    <div id="collapse3" class="accordion-body collapse">
                      <div class="accordion-inner">
                          <ul>
                            <li>Retrait d'espèces dans le monde entier, sur le réseau des guichets automatiques VISA ;</li>
                            <li>Achats en magasin, sur les terminaux de paiements (TPE) ;</li>
                            <li>Achats sur Internet : Les achats sur Internet sont sécurisés par le système « verified by
                             VISA ».</li>
                            <li>Transfert d'argent instantané d'une carte à l'autre sur le site www.myubaafricard.com
                              <ul>
                                <li> C'est une façon pratique d'envoyer des fonds à ses proches ou sa famille partout
                                 dans le monde. </li>
                              </ul>
                            </li>
                            <li>Pour les entreprises : paiements et virements en TEMPS REEL à des tiers                      
                              <ul>
                                <li> Salaires (pour employés payés en espèces) ;</li>
                                <li>Frais de missions et voyages d'affaires ;</li>
                                <li>Gratifications, primes ;</li>
                                <li>Bourses d'études. </li>
                              </ul>
                            </li>
                            <li>Consultation du solde et des transactions effectuées :
                              <ul>
                                <li>Le site www.myubaafricard.com vous permet également de vérifier le solde de votre
                                 carte et de consulter le relevé de vos transactions.</li>
                              </ul>
                            </li>
                          </ul>
                          <br />Capacité de rechargement : <strong>5.000.000 f CFA</strong>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Acheter une carte prépayée VISA  Africard</strong> </a>
                    </div>
                    <div id="collapse4" class="accordion-body collapse">
                      <div class="accordion-inner">
                        Achetez votre carte VISA Africard au prix de <strong>10 000 f CFA</strong> dans les locaux d'ARIANE en remplissant un formulaire + la photocopie de votre pièce d'identité.<br /><br />
Nos points de vente sont :<br /><br />
<ul>
<li><strong>ESN ARIANE Plateau</strong> Immeuble Les ACACIAS BD Clozel 3ème étage porte 302. Téléphone (225) 20 30 13 90</li><br />
<li><strong>ESN ARIANE Plateau DOKUI</strong> Immeuble SYLLA 2ème étage Route du Zoo face Station OILYBIA et feu tricolore du  carrefour Toute du Zoo/Route du 22ème Arrondissement. Téléphone : (225) 24 38 50 70</li><br />
<li><strong>ESN ARIANE 2 PLATEAUX</strong> derrière Hypermarché SOCOCE rue K 125. Téléphone : (225) __ ___ ___ ___ </li>
</ul>
