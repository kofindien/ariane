...
if (!isset($_SESSION)) {
  ...
  session_start();
    ...
    (isset($_POST['cel'])) ? $_SESSION['cel'] =  $_POST['cel'] : "";
}
$MM_authorizedUsers = "";
...
<form method="post" class="form-horizontal" action="alert_creer.php">
...
<div class="control-group">
           <table class="table table-hover">
               <tr>
                   <td>Services:</td> <td>Alertes voyages</td>
               <tr>
                   <td>N° de vol:</td> <td><?= $_SESSION['vol']; ?></td>
               </tr>
               <tr>
                   <td>Date de départ:</td> <td><?= $_SESSION['dateDepart']; ?></td>
               </tr>
               <tr>
               ...
               <tr>
                   <td>Cellulaire:</td> <td> <?= $_SESSION['cel']; ?></td>

               <tr>
                   <td>Coût du service:</td> <td> <?= $_SESSION['montant']; ?> F CFA</td>
               </tr>
           </table>
</div>
    <!-- FORM HIDDEN-->
    ...
    <div id="retour" style="margin-top:15px;">
        <button type="submit" name="" id="" class="btn btn-success offset5"><i class="icon-check icon-white"></i> Confirmation votre demande</button>
    </div>
</form>
