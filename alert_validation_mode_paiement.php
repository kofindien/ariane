...
if (!isset($_SESSION)) {
  ...
  session_start();
    (isset($_POST['ddepart'])) ? $_SESSION['dateDepart'] =  $_POST['ddepart'] : "".'<br/>';
    ...
    (isset($_POST['mpaie'])) ? $_SESSION['mpaie'] =  $_POST['mpaie'] : "";
}
$MM_authorizedUsers = "";
...
<form method="post" class="form-horizontal" id="" name="" action="alert_finalisation.php">
...
<div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="input-append">
      <input type="text" id="cout" name="cout" class="input-small" style="text-align:right" value="1000" readonly="readonly">
...
<div class="control-group">
  <label class="control-label" for="cel">N° cellulaire <span class="rouge">*</span></label>
    <div class="controls"><a name="cell" id="cell"></a>
      <input name="cel" type="text" required class="input-small" id="cel" placeholder="00000000" maxlength="8">     
    </div>
</div>
    <!-- FORM HIDDEN-->
  ...
  <div class="control-group">
    <div class="controls">
      ...
      <button type="button" name="return" id="return" class="btn btn-danger" onclick="window.location.replace('ampaie.php');"><i class="icon-chevron-left icon-white"></i> Précédent</button>
