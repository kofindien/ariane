...
if (!isset($_SESSION)) {
  ...
  session_start();
    ...
    (isset($_POST['MinuiteHeurevol'])) ? $_SESSION['MinuiteHeurevol'] =  $_POST['MinuiteHeurevol'] : "";
...
if ($referer =='aompay.php' || $referer =='afloozpay.php' || $referer =='afloozpay1.php'){
} else {
  echo $_SESSION['idvol'] = $_POST['idvol'];
}*/
?>
...
<form id="frmpay" name="frmpay" method="post" action="alert_validation_mode_paiement.php">
<table class="table table-striped table-hover table-bordered">
  <tr>
    ...
    <td>
    <label for="mpaie1">
    <div align="center"><img src="images/orangemoney.png" <?php RedImage("images/orangemoney.png",116,0); ?> /></div>
    </label>
    </td>
  ...
  <tr>
    ...
    <!-- FORM HIDDEN -->
<div class="control-group" align="center" style="margin-top:40px;">
    <div class="controls">
      <input name="idab" type="hidden" id="idab" value="<?php echo $row_rsAbonnement['idab']; ?>" />
      <button type="button" name="return" id="return" class="btn btn-danger" onclick="window.location.replace('alerte.php');"><i class="icon-circle-arrow-left icon-white"></i> Retour</button>
      <button type="submit" name="Submit" id="Submit" class="btn btn-primary">Suivant <i class="icon-chevron-right icon-white"></i></button>
    </div>
</div>
</form>                        
