      ...
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
           ...
           <div class="filariane" style="margin-bottom:20px; padding:10px 0;">Accueil / Achats & Paiements par Internet / Achats en ligne / Acheter en ligne. Pourquoi pas ? </div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
              <img src="img/buyline.jpg" /><br /><br />
            <img src="img/ap_accroche1.gif" />
<strong>Internet met à votre portée une multitude de produits et de services très variés dans tous les domaines</strong> : éducation, formation, commerce, santé, information, services, pièces détachées, articles divers, produits de beauté, produits médicaux, produits financiers, billets d'avion, jeux, divertissements, vidéos, images, conseils en tous genres, etc., auxquels il faut accéder par un paiement en ligne.<br /><br />
<strong>Vous souhaitez accéder à ces produits et services</strong> mais vous avez peur d'être victime d'une arnaque ou de perdre votre argent ou même de fournir des informations personnelles telles que votre numéro de compte bancaire, vos adresses et contacts personnels à des personnes que vous ne voyez pas ou même de commettre un acte illégal. Tout cela parce que pour réaliser une transaction vous traitez avec un simple écran d'ordinateur, sans savoir qui est derrière et à qui vous avez affaire. Vous avez besoin d'être rassuré.<br /><br />
Si une telle peur vous habite, <strong>vous avez raison d'être très prudent</strong>. Internet présente d'innombrables opportunités, mais également de nombreux risques d'arnaque.  C'est justement pour vous permettre d'exploiter cet outil formidable et révolutionnaire pour résoudre les problèmes de tous les jours ou concrétiser des projets ou des souhaits qui vous sont chers que nous avons créé l'<strong>ESPACE de SERVICES NUMERIQUES ARIANE</strong> ou<strong> ESN ARIANE</strong>.<br /><br />
<strong>ESN ARIANE vous ouvre les portes des achats en ligne de manière plus sûre et plus sécurisée</strong>. Avec ESN ARIANE vous traitez avec une société et des personnes que vous pouvez contacter directement, voir ou rencontrer. Vous n'êtes pas seulement dans le virtuel et dans l'anonymat, mais également dans le réel. </div>
          </div>
        </div>
      </div>
    <!-- InstanceEndEditable -->
