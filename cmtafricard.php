...
<title>VISA Africard - Comment ça marche ::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="filariane" style="margin-bottom:20px; padding:10px 0;">Carte Prépayée VISA Africard / Comment ça marche</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>

<br />
              <img src="img/cmtafricard.jpg" /><br /><br /> 
<img src="img/vaf_accroche1.gif" />
La carte prépayée VISA Africard est une carte Visa sécurisée et acceptée au niveau international pour effectuer des opérations sur les GAB (Guichet Automatique de Banque) et faire des paiements sur les TPE (Terminal de Paiement Electronique) et sur Internet.<br /><br />
Lorsque vous achetez une carte, vous recevez une lettre de félicitation et de bienvenue de la banque UBA Côte d'Ivoire. Cette lettre décrit la procédure à suivre pour utiliser votre carte.<br />
Si vous n'avez pas cette lettre à portée de main ou si vous l'avez égarée, veuillez trouver ci-dessous les informations qu'elle contient.
<br /><br />
<span class="titre">Pour activer la carte VISA Africard</span><br /><br />
<ol>
<li>Signez au dos de la carte, à l'emplacement prévu à cet effet.</li>
<li>Chargez la carte à une agence UBA CI.</li>
<li>Allez à un GAB et changez le code pin initial.</li>
</ol>
<br />
Votre carte est désormais prête à l'utilisation. Vous pouvez faire les opérations suivantes : Retrait d'espèce ; Transfert vers une autre carte prépayée Visa en temps réel ; Consulter votre solde… et cela 24h/24, 7j/7.<br /><br /><br />
<img src="img/vaf_accroche2.gif" /><br /><br />
<span class="titre">Informations utiles</span><br /><br />
<br />
<strong>CODE PIN</strong><br /><br />
Un code pin de 4 chiffres est nécessaire pour faire des transactions sur un GAB, un TPE et sur Internet.<br /><br />
<strong>ACCES AU SITE WEB AFRICARD</strong><br /><br />
Un code d'accès est remis pour accéder aux informations concernant votre carte sur le site web <a href="http://myubaafricard.com" target="_blank">http://myubaafricard.com</a>. Sur ce site, vous pouvez avoir le solde de votre carte, le relevé des transactions et des transferts effectués.<br /><br />
(Retirez la languette bleue de sécurité ci-dessous pour avoir votre code pin initial et votre code d'accès au site web Africard).
Veuillez donner votre code client (les 10 chiffres au verso de la carte) lors du chargement de votre carte dans une agence UBA, chez un distributeur agréé de cartes VISA Africard. <br /><br />
<span class="titre">Rechargez votre carte VISA Africard à distance par la plateforme ESN ARIANE</span><br /><br />
<br />
ESN ARIANE est un distributeur agréé de cartes VISA Africard qui vous offre comme avantage unique la possibilité de recharger votre carte à distance, au moyen d'Internet et des moyens de paiement des réseaux de téléphonie mobile de Côte d'Ivoire.<br /><br />
Pour plus d'informations visitez notre page <a href="recharges.php">Rechargement à distance de la carte VISA Africard</a>. </div>
          </div>
        </div>
      </div>
    <!-- InstanceEndEditable -->
