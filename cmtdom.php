...
<title>Domiciliation de commandes - Comment ça marche ::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="filariane" style="margin-bottom:20px; padding:10px 0;">Domiciliation de commandes / La domiciliation de commandes sur Internet, comment ça marche ?</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
              <img src="img/cmtdom.jpg" /><br /><br />
Nous considérons que si vous demandez à domicilier votre commande de produit auprès d'ESN ARIANE, c'est que vous n'êtes pas en mesure de vous faire livrer le produit chez vous et que vous souhaitez que le produit que vous vous apprêtez à acheter sur Internet soit domicilié auprès de cette société.
<br /><br />
Dans ce cas, vous devrez suivre les étapes suivantes :<br /><br />
<ol>
<li type="a">Vous rendre sur l'un des sites d'ESN ARIANE au Plateau, au Deux Plateaux ou au Plateau DOKUI pour effectuer les formalités de domiciliation de la commande</li><br />
<li type="a">Ouvrir un compte auprès d'ARIANE pour vous identifier et fournir les adresses auxquels vous serez contacté pour vous donner des informations relatives à votre commande</li><br />
<li type="a">Trouver le produit que vous souhaitez commander sur Internet</li><br />
<li type="a">Communiquer à l'agent de service les références du produit au moyen du lien par lequel il peut être retrouvé sur Internet</li><br />
<li type="a">Remplir et signer la fiche de commande de votre produit qui tient lieu de contrat de paiement de la commande</li><br />
<li type="a">Payer l'avance sur la commande indiquée par ESN ARIANE</li><br />
<li type="a">Rester à l'écoute d'ESN ARIANE qui vous communiquera la date approximative de livraison de votre commande à Abidjan ou à tout autre endroit de Côte d'Ivoire</li><br />
<li type="a">Lorsque le produit est arrivé, vous rendre sur le site d'ARIANE où vous avez domicilié votre commande pour la récupérer.</li>
</ol>
<br /><br />
