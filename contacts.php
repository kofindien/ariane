   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:1100px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Contacts</div>
    ...
    <div style="padding:10px;">
        ...
        <address>
          <strong>ESN ARIANE Plateau</strong><br>
          Immeuble Les ACACIAS BD Clozel 3ème étage porte 302<br>
          <abbr title="Téléphone">Tél. :</abbr> +225 20 30 13 90 - 
          <abbr title="Cellulaire">Cel. :</abbr> +225 58 02 10 54<br>
          E-mail : infos@ariane.ci
        </address>
        
        <address>
          <strong>ESN ARIANE Plateau Dokui</strong><br>
          Immeuble SYLLA 2ème étage Route du Zoo face Station OILYBIA et feu tricolore du  carrefour Toute du Zoo/Route du 22ème Arrondissement<br>
          <abbr title="Téléphone">Tél. :</abbr> +225 24 38 50 70 - <abbr title="Cellulaire">Cel. :</abbr> +225 58 02 52 10<br>
        </address>
        
        <address>
          <strong>ESN ARIANE II Plateaux SOCOCE</strong><br>
          derrière Hypermarché SOCOCE rue K 125<br>
          <abbr title="Téléphone">Tél. :</abbr> +225 22 41 14 16 - <abbr title="Fax">Fax :</abbr> +225 22 41 14 17<br>
        </address>
           
      </div>
      <div style="border:1px solid #CCC; padding:10px; background-color:#EFEFEF;">
        <iframe src="https://maps.google.com/maps/ms?msa=0&amp;msid=215193154143465961752.0004d11723d6bf2dc0c4d&amp;hl=fr&amp;ie=UTF8&amp;t=m&amp;ll=5.325483,-4.020516&amp;spn=0,0&amp;output=embed" width="100%" height="250" frameborder="0"></iframe>
      </div>
      <br /><br /><strong>Vous voulez nous contacter ? Utilisez le formulaire ci-dessous.</strong><br /><br /><br />
<div>
<form action="" method="post" class="form-horizontal">
<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="identite">Identité <span class="rouge">*</span></label>
  <div class="controls">
    <input id="identite" name="identite" type="text" placeholder="Nom et prénoms" class="input-xlarge" required="">
  </div>
</div>
...
<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="tel">Cellulaire <span class="rouge">*</span></label>
  <div class="controls">
    <input id="tel" name="tel" type="text" placeholder="00 00 00 00" class="input-xlarge" required="">
  </div>
</div>

<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="message">Message <span class="rouge">*</span></label>
  <div class="controls">
    <textarea name="message" id="message" cols="47" rows="3" placeholder="Message" required="" style="width:70%;"></textarea>
  </div>
</div>

<div align="center">
<input name="frmSend" type="hidden" id="frmSend" value="ok" />
<button class="btn btn-small btn-success" type="submit"><i class="icon-white icon-envelope"></i> Envoyer</button>
<input name="annuler" type="reset" id="annuler" value="Annuler" class="btn btn-small btn-primary" />
</div>
</form>
</div>      
