...
$queryOperations = sprintf("SELECT recharges.idr FROM recharges, abonnements WHERE recharges.status = 1 AND recharges.idab = abonnements.idab AND abonnements.idcl = %s", GetSQLValueString($colname_histo, "int"));
...
mysql_select_db($database_liaisondb, $liaisondb);
$query_rsOperations = sprintf("SELECT recharges.idr, recharges.idab, recharges.montant, recharges.frais, recharges.mpaie, recharges.cel, recharges.dateaj, recharges.status, recharges.dateserv, services.service FROM recharges, abonnements, services WHERE recharges.idab = abonnements.idab AND abonnements.ids = services.ids AND abonnements.idcl = %s AND recharges.status = 0 ORDER BY recharges.idr DESC", GetSQLValueString($colname_histo, "int"));
...
<title>Opérations en cours ::: Ariane</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:600px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div>
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Espace client &raquo; Opérations en cours</div>
           ...
           <table class="table table-striped table-hover" width="100%" border="0" cellspacing="1" cellpadding="2">
              ...
              <?php do { ?>
                ...
                wrapperClassName: 'titlebar' } )"><?php LongDateEN2dateFR($row_rsOperations['dateaj']); ?></a></td>
                    <td width="28%"><?php echo $row_rsOperations['service']; ?></td>
                    ...
                    <td align="center"><a href="recupending.php?id=<?php echo $row_rsOperations['idr']; ?>" title="Imprimer le reçu" target="_blank"><img src="img/pdf.png" <?php RedImage("img/pdf.png",25,0); ?> /></a></td>
                    </tr>
            ...
            <div style="margin-bottom:70px;">
                <?php
                    ...
                    echo paginate('cours.php', '?page=', $totalPages_rsOperations, $current);
                ?>
            </div>
