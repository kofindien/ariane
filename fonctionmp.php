...
<title>Emplois MON PROFIL - Comment ça marche  ::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
                ...
                <div class="accordion" id="accordion2">
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Etape 2 : Se connecter à son compte ARIANE et souscrire au service  « Emplois MON PROFIL »</strong> </a>
                    </div>
                    <div id="collapse2" class="accordion-body collapse">
                      <div class="accordion-inner">
                        Une fois votre compte ARIANE créé, veuillez vous connecter et souscrire  au service « Emplois MON PROFIL ».
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Etape 3 : Avoir la somme destinée à régler ou renouveler votre abonnement au service           « Emplois MON PROFIL » sur votre compte ORANGE Money, FLOOZ ou PAYPAL</strong> </a>
                    </div>
                    <div id="collapse3" class="accordion-body collapse">
                      <div class="accordion-inner">
                          <ul>
                            <li>Avoir sur votre compte ORANGE Money, FLOOZ ou PAYPAL la somme destinée à l’abonnement au service augmentée des frais de la plateforme.</li>
                  ...
                  <div class="accordion-group">
                    <div class="accordion-heading">
                      ...
                      <strong>Etape 4 : Payez les frais d’abonnement / ou renouvelez l'abonnement au service « Emplois MON PROFIL »</strong> </a>
                    </div>
                    <div id="collapse4" class="accordion-body collapse">
                      <div class="accordion-inner">
                          <ul>
                            <li>Cliquez sur « Réglez / Renouvelez mon abonnement au service ».</li>
                            <li>Sélectionnez le moyen de paiement (ORANGE Money, FLOOZ ou PAYPAL) et suivez les instructions.</li>
                          </ul>
                      </div>
                    </div>
                  </div>
                    ...
                    <div id="collapse5" class="accordion-body collapse">
                      <div class="accordion-inner">
                          ...
                          <ul>
                            ...
                            <li>Vous recevrez ensuite un SMS de confirmation de votre règlement ou abonnement avec tous les détails de l'opération ainsi que votre nouveau solde.</li>
