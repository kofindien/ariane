...
<div style="padding:0 0 5px 0; border-bottom:1px solid #06C; margin-bottom:15px;"><strong>Informations sur le compte :</strong></div>
  ...
  <div class="control-group">
    <label class="control-label" for="motpass">Mot de passe <span class="rouge">*</span></label>
    <div class="controls"><span id="sprytextfield1">
      <input type="password" class="input-medium" name="motpass" id="motpass" placeholder="Mot de passe" required="required" />
