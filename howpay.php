	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          ...
          <div class="filariane" style="margin-bottom:20px; padding:10px 0;">« Accueil / Achats & Paiements par Internet / Paiements en ligne / Comment payer sur Internet ?</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
              <img src="img/howpay.jpg" /><br /><br />
Quelle que soit votre situation, grâce à l'ESPACE DE SERVICES NUMERIQUES ARIANE ou ESN ARIANE vous avez le choix :
<br /><br />
 	<ul>
    <li>Soit vous savez comment effectuer un paiement en ligne mais ne disposez pas de moyen de paiement ; dans ce cas, ESN ARIANE vous fournit un moyen de paiement qui est la <a href="africard.php">Carte Prépayée VISA AFRICARD</a> que vous pouvez recharger du montant que vous souhaitez et effectuer votre achat en ligne. C'est le mode <strong>Paiement en Ligne libre</strong> (<strong>PLL</strong>).</li><br />
 	<li>Soit vous ne savez pas comment effectuer un paiement en ligne et, dans ce cas, ESN vous offre une assistance complète. C'est le mode <strong>Paiement en Ligne Assisté</strong> (<strong>PLA</strong>).</li>
    </ul>
En mode<strong> Paiement en Ligne Libre</strong>, ESN ARIANE se limite à vous permettre d'acquérir un moyen de paiement performant et sécurisé, la Carte Prépayée <strong>VISA AFRICARD</strong> et de charger cette carte de la somme nécessaire pour effectuer votre achat en ligne. Cette assistance peut vous être fournie à distance, si vous possédez déjà une carte<strong> VISA AFRICARD</strong>, à travers notre site <a href="./">www.ariane.ci</a> . <br /><br />
Le rechargement de cette carte peut également se faire à distance. Pour cela, il faut aller à l'<a href="login.php">Espace Client</a> de la page d'accueil du site <a href="./">www.ariane.ci</a>, muni d'une carte ORANGE MONEY, MTN MOBILE MONEY ou FLOOZ contenant déjà la somme que vous voulez transférer sur votre Carte Prépayée <strong>VISA AFRICARD</strong> pour effectuer le paiement en ligne. <br /><br />
La carte <strong>VISA AFRICARD</strong> est une carte VISA authentique, qui est valable dans plus de 120 pays et vous offre toutes les protections et sécurités des cartes VISA ordinaires. <br /><br />
Vous pouvez également vous rendre sur l'un des trois sites d'<strong>ESN ARIANE </strong>au Plateau, au Plateau Dokui ou aux <a href="#">Deux Plateaux</a> pour acheter une Carte Prépayée <strong>VISA AFRICARD</strong>, recharger votre carte et effectuer le paiement en ligne. ESN ARIANE tient à la disposition de ses clients un espace cyber dédié leur permettant d'effectuer recherche et achats en ligne. <br />
<br />
En mode <strong>Paiement en Ligne Assisté</strong>, ESN ARIANE vous fournit la Carte Prépayée <strong>VISA AFRICARD</strong>, vous assiste pour la recharger et pour effectuer le paiement. Vous pouvez effectuer le paiement vous-même avec votre propre carte <strong>VISA AFRICARD</strong> ou vous pouvez demander à ESN ARIANE de le faire pour votre compte et pour votre bénéfice avec une carte d'<strong>ESN ARIANE</strong>. </div>
          </div>
        </div>
      </div>
    <!-- InstanceEndEditable -->
