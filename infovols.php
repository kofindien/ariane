...
if (!isset($_SESSION)) {
  ...
  session_start();
  //On recupere les infos postees a la page precedente
   (isset($_POST['ddepart'])) ? $_SESSION['ddepart'] =  $_POST['ddepart'] : "";
...
<div class="control-group">
  <label class="control-label" for="lservice">Service</label>
    <div class="controls">
      <input name="lservice" type="text" readonly class="input-large" id="lservice" value="Alertes voyages">
  ...
  <div class="control-group">
    <label class="control-label" for="vol">N° de vol</label>
     <div class="controls">
      <input name="vol" type="text" readonly class="input-large" id="vol" value="<?= trim($_SESSION['vol']); ?>">
    </div>
  </div>
  ...
  <div class="control-group">
    <label class="control-label" for="ddepart">Date de départ</label>
     <div class="controls">
        <input name="ddepart" type="text" readonly class="input-large" id="ddepart" value="<?= trim($_SESSION['ddepart']); ?>">
    </div>
  </div>
    <div class="control-group">
        <label class="control-label" for="ddepart">Heure du vol</label>
        <div class="controls">
            <input name="ddepart" type="text" readonly class="input-large" id="ddepart" value="<?= trim($_SESSION['Heurevol']).' h '.trim($_SESSION['Minuitevol']).' min'; ?>">
        </div>
    </div>

    <div class="control-group">
        <label class="control-label" for="cout">Coût du service</label>
        <div class="controls">
            <div class="input-append">
                <input type="text" id="cout" name="montant" class="input-small" style="text-align:right" value="1000" readonly="readonly">
...
<button type="submit" id="Submit" name="Submit" class="btn btn-primary">Validation &rarr;</button>
    </div>
</div>
</form>
