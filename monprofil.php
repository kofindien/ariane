...
<title>Emplois MON PROFIL - Présentation ::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Emplois MON PROFIL &raquo;</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
              <img src="img/job.jpg" width="655" height="111" /><br />
              <br />
              MON PROFIL est le service personnalisé de recherche d'emploi. C'est  un service qui vous permet de recevoir, pendant la durée de votre abonnement, des offres spécifiques à votre profil. L'abonnement est payé par transfert d'argent par téléphone mobile sur les comptes ORANGE Money, MTN Mobile Money, FLOOZ ou PAYPAL).<br /><br />
Pour les besoins du service, le profil de compétence est défini par les éléments suivants :
<br /><br />
              <ul>
                <li>DOMAINE DE COMPETENCE</li>
                <li>NIVEAU D'ETUDES</li>
                <li>DIPLOME</li>
                <li>NOMBRE D'ANNEES D'EXPERIENCE</li>
                <li>NIVEAU D'ETUDES</li>
                <li>AGE</li>
              </ul>
              
Une fois le service activé, le souscripteur est prêt à consulter les offres d'emplois  correspondant à son profil sur son espace client ARIANE durant la période de son abonnement.<br /><br />
Si l'abonné a plusieurs domaines de compétence ou plusieurs diplômes, il aura la possibilité de modifier son profil de compétences dans l'onglet « Modifier les informations sur le service » pour recevoir de nouvelles offres d'emplois correspondant au nouveau profil.<br /><br />       
<strong>Les avantages</strong><br /><br />
Avec EMPLOIS, c'est le travail qui vient à vous. <br />
MON PROFIL change profondément la manière dont vous cherchez du travail.<br /><br />
              <ul>
                <li>Vous cherchez du travail, mais ne pouvez consacrez à ce besoin vital le temps, les ressources et l'énergie nécessaires ? MON PROFIL  cherche pour vous et met les résultats de ses recherches à votre disposition.  Ainsi, vous économisez du temps, de l'énergie et de l'argent et vous pouvez vous consacrer sans contrainte à vos autres occupations.</li><br />
                <li>Vos efforts de recherche d'emploi  deviennent plus productifs. TOUS LES JOURS, TOUTE L'ANNEE,  A TOUT MOMENT ET PARTOUT EN COTE D'IVOIRE ET AILLEURS DANS LE MONDE, vous pouvez désormais consulter les offres d'emplois disponibles sur www.ariane.ci grâce à votre téléphone mobile, ordinateur, tablette ou Smartphone.</li><br />
                <li>Vous pouvez ainsi postuler pour des offres d'emplois disponibles en Côte d'Ivoire provenant de la Fonction Publique, d'entreprises ivoiriennes ou étrangères, d'ONG, d'organisations internationales et d'entreprises multinationales.</li>
              </ul>
