...
<form id="frmpay" name="frmpay" method="post" action="redirectpay.php">
<table class="table table-striped table-hover table-bordered">
  ...
  <tr>
    <td>
      <div align="center">
        <input type="radio" name="mpaie" id="mpaie5" value="PayPal" required="required" disabled="disabled" />
        </div>
      </td>
    <td><label for="mpaie5"><div align="center"><img src="images/paypal_over.png" width="116" height="34" /></div></label></td>
    <td><label for="mpaie5">PayPal (Bientôt disponible)</label></td>
  </tr>
</table>
