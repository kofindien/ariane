...
jQuery(document).ready(function($){
	...
	$("#Submit").click(function(){
		...
		$.post('updatemp.php', {motpasse: motpasse, ancienpwd: ancienpwd},
		function(data){
			$("#message").html(data);
			$("#message").hide();
			$("#flash").hide();
   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:480px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
                ...
                <div style="padding:0 0 5px 0; border-bottom:1px solid #06C; margin-bottom:15px;"><strong>Modifier le mot de passe :</strong></div>
                  ...
                  <div class="row-fluid" style="margin-bottom:20px;">
                    ...
                    <div class="span7"><span id="spryconfirm1">
                      <input type="password" name="motpass" id="motpass" placeholder="Répétez le nouveau mot de passe" required />
      ...
      <script type="text/javascript">
var spryconfirm1 = new Spry.Widget.ValidationConfirm("spryconfirm1", "motpasse");
      </script>
	<!-- InstanceEndEditable -->
    </div>
