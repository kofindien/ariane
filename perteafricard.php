...
<title>VISA Africard - Que faire en cas de perte ? ::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="filariane" style="margin-bottom:20px; padding:10px 0;">Carte Prépayée VISA Africard / Que faire en cas de perte ?</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
                
              <div style="min-height:250px;">
              
          <strong><img src="img/perte.jpg" /><br />
          <br />
          </strong><br />      
            Il faut informer la banque immédiatement ou se rendre dans un point agréé pour faire opposition.
            <br /><br />
            Si vous commandez une nouvelle carte, les fonds disponibles sur l'ancienne carte seront transférés 
            sur la nouvelle.
            <br /><br />Vous pouvez aussi contacter la banque UBA Côte d’Ivoire :<br /><br />
            <strong>par téléphone : 225 20 31 22 22 ou 225 80 200 000</strong><br />
            <strong>par e-mail d'urgence : ebanking-ci@ubagroup.com </strong>
