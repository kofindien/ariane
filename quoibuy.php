	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          ...
          <div class="filariane" style="margin-bottom:20px; padding:10px 0;">Accueil / Achats & Paiements par Internet / Achats en ligne / Que peut-on acheter sur Internet ?</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>
              <img src="img/quoibuy.jpg" /><br /><br />
On peut pratiquement tout acheter sur Internet, y compris des voitures et même des maisons.<br /><br />
Mais le plus grand nombre d'achats dans les pays africains concerne les vêtements, les produits de beauté et de santé, la maroquinerie, les bijoux, les parfums, les pièces de rechange pour véhicules, machines et équipements, les abonnements à des services en ligne (journaux, cours, informatiques, plateformes d'échanges professionnels ou commerciaux), accessoires et fournitures informatiques, électronique, cellulaires et accessoires, Smartphones, tablettes, logiciels, noms de domaines, jeux, paris sportifs et autres, conseils, enseignements religieux ou spécialisés, etc.).<br /><br />
<img src="img/ap_accroche2.gif" />
</div>
          </div>
        </div>
      </div>
