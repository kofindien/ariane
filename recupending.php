...
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(50, 5, '  Rechargement en attente', 1, 1, 'L');
...
$pdf->SetFont('helvetica', '', 12);
	...
	$pdf->Cell(150, 5, 'Montant à prélever sur le compte '.$row_rsOperation['mpaie'], 0, 0, 'L',0,'',1);
	...
	$pdf->Ln(10);
$pdf->SetFont('helvetica', 'B', 12);
	$pdf->Cell(150, 5, 'Montant à recharger sur la carte prépayée VISA UBA Africard ', 0, 0, 'L',0,'',1);
