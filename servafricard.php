...
if ((isset($_POST['frmSend'])) && ($_POST['frmSend']=='Apply')) {
	  ...
	  $insertSQL = sprintf("INSERT INTO abonnements (idcl, ids, numcard, dvalidite, numid) VALUES (%s, %s, %s, %s, %s)",
	...
	if ($Result1) $alerte = '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>La souscription au service de rechargement de carte prépayée VISA UBA Africard a été bien prise en compte ! Vous pouvez désormais effectuer des demande de rechargement de votre carte prépayée VISA UBA Africard en ligne sur notre www.ariane.ci</div>';
	else $alerte =  '<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button>La souscription au service de rechargement de carte prépayée VISA UBA Africard a échoué... Veuillez recommencer !</div>';
}
?>
...
<form action="servafricard.php" method="post" class="form-horizontal" id="Apply" name="Apply">
...
<div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="numcard" name="numcard" class="input-medium" placeholder="0000-0000-0000-0000" required>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="dvalidite">Date de validité <span class="rouge">*</span></label>
    <div class="controls">
    <input type="text" id="dvalidite" name="dvalidite" class="input-mini" placeholder="00/00" required maxlength="5">&nbsp;&nbsp;(mm/aa; ex. : 10/16)
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="numid">N° Client ID <span class="rouge">*</span></label>
    <div class="controls">
      <input name="numid" type="text" required class="input-small" id="numid" placeholder="0000000000" maxlength="10">&nbsp;&nbsp;&nbsp;(<a href="images/versoafricard.jpg" class="highslide" onclick="return hs.expand(this)">Voir où trouver le n° sur la carte</a>) </div>
  </div>
  <div class="control-group">
    <div class="controls">
...
<button type="submit" id="Submit" name="Submit" class="btn btn-primary"><i class="icon-check icon-white"></i> Souscrire</button>
    </div>
</div>
</form>
<?php } else { ?>
