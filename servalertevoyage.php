...
if ((isset($_POST['frmSend'])) && ($_POST['frmSend']=='Apply')) {
	  ...
	  $insertSQL = sprintf("INSERT INTO abonnements (idcl, ids) VALUES (%s, %s)",
...
<form action="servalertevoyage.php" method="post" class="form-horizontal" id="Apply" name="Apply">
...
<div class="control-group">
  <label class="control-label" for="lservice">Service <span class="rouge">*</span></label>
    <div class="controls">
      <input name="lservice" type="text" disabled="disabled" required class="span3" id="lservice" value="Alertes Voyages"><input name="ids" id="ids" type="hidden" value="3">
    </div>
</div>
  <div class="control-group">
    <div class="controls">
