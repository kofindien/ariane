...
<title>Simuler un rechargement de sa carte VISA prépayée UBA ::: Espace de Services Numériques - Ariane</title>
<!-- InstanceEndEditable -->
   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      ...
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:700px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:5px; padding:10px 0;">
                Espace client &raquo; Simuler un rechargement de sa carte</div>
...
<form method="post" class="form-horizontal" id="frmSimulate" name="frmSimulate">
...
<script type="text/javascript">	
	function cFrais(){
		...
		var fraisp = 0.0;
		var mt = 0;
		var mtr = document.forms["frmSimulate"].mtr.value;
		...
		document.forms["frmSimulate"].fraisp.value = fraisp;
		if (mt) document.forms["frmSimulate"].montant.value = mt;
		else document.forms["frmSimulate"].montant.value = 0;
		document.forms["frmSimulate"].frais.value = frais;
	}
</script>
  <div class="control-group">
    <label class="control-label" for="mtr">Montant à recharger sur la carte prépayée VISA UBA Africard <span class="rouge">*</span></label>
    <div class="controls" style="padding-top:25px;">
    <div class="input-append">
      <input type="text" id="mtr" name="mtr" class="input-small" style="font-weight:bold; color:#F00; text-align:right" placeholder="0" required="required">
  ...
  <div class="control-group">
    <label class="control-label" for="montant">Montant à prélever sur le compte (Orange Money / MTN Mobile Money / Flooz / BankCell / PayPal)</label>
    <div class="controls" style="padding-top:25px;">
    <div class="input-append">
      <input type="text" id="montant" name="montant" class="input-small" style="text-align:right; font-weight:bold; color:#F00;" readonly="readonly" placeholder="0">
      <span class="add-on">F CFA</span>
    </div>
    </div>
  </div>
<div class="control-group">
    <div class="controls">
	<input name="Reset" type="reset" id="Reset" value="Annuler" class="btn btn-danger" />
    <button type="button" class="btn btn-primary" onclick="cFrais();"><i class="icon-check icon-white"></i> Calculer</button>
    </div>
  </div>
</form>
<br />
