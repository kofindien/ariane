...
<title>Tarification des services ::: Ariane</title>
<!-- InstanceEndEditable -->
        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Tarification des services</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>

<br />
<table class="table table-bordered table-hover table-striped" width="90%">
  <thead>
  <tr>
    <th>Service</th>
    <th>Prix FCFA</th>
  ...
  <tr>
    <td>&nbsp;</td>
    <td nowrap="nowrap" colspan="2" valign="bottom">Toutes taxes comprises</td>
  </tr>
  <tr class="info">
    <td>Assistance à la recherche d'un produit sur Internet</td>
    <td>gratuit</td>
    <td>gratuit</td>
  </tr>
  <tr>
    <td>Carte VISA AFRICARD (hors rechargement)</td>
    <td>10 000</td>
    <td>15</td>
  </tr>
  <tr class="info">
    <td>Rechargement Carte Prépayée VISA AFRICARD par Internet <br />
      via la plateforme ESN ARIANE<br />
      - montant inférieur ou égal à 55 000 FCFA (84 EUROS)<br />
      - montant supérieur à 55 000 FCFA (84 EUROS)</td>
    <td><br />
      <br />
      350<br />
      0,7%</td>
  ...
  <tr>
    <td>Assistance au paiement en ligne<br />
      (Paiement en Ligne Assisté)</td>
    <td>1 000</td>
    <td>2,00</td>
  </tr>
  <tr class="info">
    <td>Domiciliation de commande à ESN ARIANE Abidjan<br />
      (hors frais de transport et de douane)</td>
    <td>10 000</td>
    <td>15,00</td>
  </tr>
  <tr>
    <td>Alerte Passagers AVION</td>
    <td>1&nbsp;000</td>
    <td>2,00</td>
  </tr>
  </tbody>
...
<blockquote>
  <small>Tarifs en vigueur à compter du 1er décembre 2014</small>
</blockquote>
            </div>
          </div>
        </div>
