...
<span style="color:#099; padding-top:15px;">ARIANE " SHOW ME THE WAY "</span>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr align="center" valign="top">
    <td width="20%">
    	<div class="myDiv" style="margin-right:10px;">
        ...
        <div style="padding:20px 15px; background-color:#FFF; height:40px;">
          <div>Concrétiser vos opportunités.</div>
        </div>
        ...
        <div style="padding:20px 8px; background-color:#FFF;">
    ...
    <td width="20%">
    	<div class="myDiv" style="margin:0 5px;">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; background-color:#FFF; height:40px;">
    ...
    <td width="20%">
    	<div class="myDiv" style="margin:0 5px;">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; background-color:#FFF; height:40px;">
          <div style="font-size:12px; padding-bottom:8px;">CARTES BANCAIRES</div>
          <div>prépayées</div>
        </div>
        <div style="padding:20px 15px; background-color:#FFF;">
        ...
        <div style="background-color:#FFF;">
            <input type="button" name="button" id="button" value="En SAVOIR +" style="background-color:#666; border:1px solid #666; color:#FFF; font-size:11px; padding:5px 25px;" onclick="window.location.replace('africard.php');" />
        </div>
        <div style="padding:20px 8px; background-color:#FFF;">
          <div align="left" style="font-size:11px; padding:5px"><a href="africard.php"><i class="icon-share-alt"></i> Présentation</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Comment ça marche ?</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Souscrire au service</a></div>
        </div>
        </div>
    ...
    <td width="20%">
    	<div class="myDiv" style="margin:0 5px;">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; background-color:#FFF; height:40px;">
          <div style="font-size:12px; padding-bottom:8px;">TRAVEL*STAR</div>
          <div>Passagers AVION<br />Alertes Voyages</div>
        </div>
        <div style="padding:20px 15px; background-color:#FFF;">
    ...
    <td width="20%">
    	<div class="myDiv" style="margin-left:10px;">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; background-color:#FFF; height:40px;">
        ...
        <div style="border-top:1px solid #666; margin:0 25%;"></div>
        <div style="padding:20px 15px; background-color:#FFF; height:40px;">
          <div>Chercher un emploi plus efficacement.</div>
        </div>
        <div style="background-color:#FFF;">
            <input type="button" name="button" id="button" value="En SAVOIR +" style="background-color:#666; border:1px solid #666; color:#FFF; font-size:11px; padding:5px 25px;" />
        </div>
...
Faites votre choix. Nous sommes en soutien.<br /><br /><strong style="color:#F00;">Comment Souscrire ?  <a href="frmcompte.php">Cliquez ICI</a></strong>
</div>
