...
$query_rsProfil = sprintf("SELECT clients.idcl, clients.civilite, clients.nom, clients.prenoms, clients.cel, abonnements.idab, abonnements.numcard, abonnements.dvalidite FROM clients, abonnements WHERE clients.idcl = abonnements.idcl AND clients.idcl = %s", GetSQLValueString($colname_rsProfil, "int"));
...
jQuery(document).ready(function($){
	...
	$("#Submit").click(function(){
		...
		if (civilite =="" || nom =="" || prenoms =="" || cel =="" || idab =="" || numcard =="" || dvalidite ==""){
		...
		$.post('updateprofil.php', {civilite: civilite, nom: nom, prenoms: prenoms, cel: cel, idab: idab, numcard: numcard, dvalidite: dvalidite},
		function(data){
			$("#message").html(data);
			$("#message").hide();
			$("#flash").hide();
   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:380px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Espace client &raquo; Modifier son profil</div>
...
<div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="input-prepend">
      ...
      <input name="cel1" type="text" required="required" class="input-small" id="cel1" placeholder="00000000" value="<?php echo $row_rsProfil['cel']; ?>">
    </div>
    </div>
  </div>
<div style="padding:0 0 5px 0; border-bottom:1px solid #06C; margin-bottom:15px;"><strong>Informations sur service :</strong></div>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input name="numcard" type="text" required="required" class="input-medium" id="numcard" placeholder="0000-0000-0000-0000" value="<?php echo $row_rsProfil['numcard']; ?>">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="dvalidite">Date de validité <span class="rouge">*</span></label>
    <div class="controls">
      <input name="dvalidite" type="text" required="required" class="span1" maxlength="5" id="dvalidite" placeholder="0000" value="<?php echo $row_rsProfil['dvalidite']; ?>">
    </div>
  </div>
  <div class="control-group">
    <div class="controls">
