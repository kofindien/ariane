   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:780px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
              ...
              <div style="min-height:250px;">
                ...
                <strong><u>Présentation</u></strong> :<br /><br />
                  La carte Visa Prépayée UBA est une carte de retrait rechargeable qui vous offre une multitude de possibilités et son coût est très abordable. <br />
                  <br />
                  Elle n'est pas rattachée à un compte bancaire, ce qui procure flexibilité et mobilité à ses utilisateurs.
                  <br />
                  <br />
                  La carte est utilisable dans le monde entier sur le réseau VISA. <br /><br />
  <strong><u>Fonctionnalités</u></strong> :<br /><br />
                  <ul>
                  ...
                  <br /><br />Capacité de rechargement : 5.000.000 f CFA
                </div>
                  
                  <div style="float:right; width:46%; text-indent:0.5px; padding-right:20px;">
                  <strong><u>Avantages</u></strong> :<br /><br />
...
<br />
                        <strong><u>Que faire en cas de perte de la carte ?</u></strong><br /><br />
                        Il faut informer la banque immédiatement ou se rendre dans un point agréé pour faire opposition.
                        <br />
                        <br />
                        Si vous commandz une nouvelle carte, les fonds disponibles sur l'ancienne carte seront transférés sur la nouvelle. <br />
                        <br />
                        E-mail d'urgence : ebanking-ci@ubagroup.com <br /><br />
                </div>
