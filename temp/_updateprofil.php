...
if ((isset($_POST['civilite'])) && !empty($_POST['civilite']) && (isset($_POST['nom'])) && !empty($_POST['nom']) && (isset($_POST['prenoms'])) && !empty($_POST['prenoms']) && (isset($_POST['cel'])) && !empty($_POST['cel']) && (isset($_POST['numcard'])) && !empty($_POST['numcard']) && (isset($_POST['dvalidite'])) && !empty($_POST['dvalidite']) && (isset($_POST['idab'])) && !empty($_POST['idab'])) {				
