        ...
        <div style="padding:25px; border:1px solid #CCC; min-height:270px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px; padding-bottom:100px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">FAQ</div>
                
              <div>
                
                    <div style="float:left; width:46%; text-indent:0.5px;">
<span class="titreMarron">Que faire en cas de perte de la carte ?</span><br /><br />
Il faut informer la banque immédiatement ou se rendre dans un point agréé pour faire opposition. 
<br /><br />
Si vous commandez une nouvelle carte, les fonds disponibles sur l'ancienne carte seront transférés sur la nouvelle. 
<br /><br />
E-mail d'urgence : ebanking-ci@ubagroup.com
                </div>
                  
                  <div style="float:right; width:46%; text-indent:0.5px; padding-right:20px;">
<span class="titreMarron">Que faire en cas de code erroné ?</span><br /><br />
Il faut se rendre dans nos points agréés pour une réédition de code. Cette réédition est gratuite.<br /><br />
Le samedi de   7h00 à 20h30 : trajet Génie 2000 Faya/route de Bingerville – Plateau/rue du Commerce.<br /><br />
<span class="titreMarron">Pièces à fournir pour souscrire à la carte</span><br /><br />
La pièce d'identité et le formulaire de souscription dûment rempli.
                  </div>
