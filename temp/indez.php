...
<span style="color:#099;">ARIANE " SHOW ME THE WAY "</span>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr align="center" valign="top">
    <td width="20%">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; margin-right:10px; background-color:#FFF; height:40px;">
          <div style="font-size:15px; padding-bottom:8px;">INTERNET</div>
          <div>Achat & Paiement en ligne</div>
        </div>
        <div style="padding:20px 15px; margin-right:10px; background-color:#FFF;">
          <img src="img/servinternet.jpg" />
        </div>
        <div style="padding:20px 15px; margin-right:10px; background-color:#FFF; border-top:1px solid #000; height:40px;">
          <div>Plus facile, plus simple et sécurisé.</div>
        </div>
        <div style="border-top:1px solid #666; margin:0 25%;"></div>
        <div style="padding:20px 15px; margin-right:10px; background-color:#FFF; height:40px;">
          <div>Concrétisé vos opportunités.</div>
        </div>
        <div style="margin-right:10px; background-color:#FFF;">
            <input type="button" name="button" id="button" value="En SAVOIR +" style="background-color:#666; border:1px solid #666; color:#FFF; font-size:11px; padding:5px 25px;" />
        </div>
        <div style="padding:20px 8px; margin-right:10px; background-color:#FFF;">
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Présentation</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Comment ça marche ?</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Souscrire au service</a></div>
        </div>
    </td>
    <td width="20%">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; margin:0 5px; background-color:#FFF; height:40px;">
          <div style="font-size:15px; padding-bottom:8px;">DOMICILIATION</div>
          <div>de vos commandes sur Internet</div>
        </div>
        <div style="padding:20px 15px; margin:0 5px; background-color:#FFF;">
          <img src="img/domiciliation.jpg" />
        </div>
        <div style="padding:20px 15px; margin-right:10px; background-color:#FFF; border-top:1px solid #000; height:40px;">
          <div>Acheter en toute sérénité sur le net.</div>
        </div>
        <div style="border-top:1px solid #666; margin:0 25%;"></div>
        <div style="padding:20px 15px; margin:0 5px; background-color:#FFF; height:40px;">
          <div>Acheter librement... Développer votre commerce.</div>
        </div>
        <div style="margin:0 5px; background-color:#FFF;">
            <input type="button" name="button" id="button" value="En SAVOIR +" style="background-color:#666; border:1px solid #666; color:#FFF; font-size:11px; padding:5px 25px;" />
        </div>
        <div style="padding:20px 8px; margin:0 5px; background-color:#FFF;">
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Présentation</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Comment ça marche ?</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Souscrire au service</a></div>
        </div>
    ...
    <td width="20%">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; margin:0 5px; background-color:#FFF; height:40px;">
          <div style="font-size:15px; padding-bottom:8px;">CARTES BANCAIRES</div>
          <div>prépayée</div>
        </div>
        <div style="padding:20px 15px; margin-right:10px; background-color:#FFF;">
          <img src="img/servafricard.jpg" />
        </div>
        <div style="padding:20px 15px; margin:0 5px; background-color:#FFF; border-top:1px solid #000; height:40px;">
          <div>Voyagez partout dans le monde avec VISA UBA Africard.</div>
        </div>
        <div style="border-top:1px solid #666; margin:0 25%;"></div>
        <div style="padding:20px 15px; margin:0 5px; background-color:#FFF; height:40px;">
          <div>Recharger votre carte à partir de 10.000 points de ventes.</div>
        </div>
        <div style="margin:0 5px; background-color:#FFF;">
            <input type="button" name="button" id="button" value="En SAVOIR +" style="background-color:#666; border:1px solid #666; color:#FFF; font-size:11px; padding:5px 25px;" />
        </div>
    ...
    <td width="20%">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; margin:0 5px; background-color:#FFF; height:40px;">
          <div style="font-size:15px; padding-bottom:8px;">TRAVEL*STAR</div>
          <div>Alertes Voyages</div>
        </div>
        <div style="padding:20px 15px; margin:0 5px; background-color:#FFF;">
    ...
    <td width="20%">
        <div style="border-top:3px solid #06C; border-bottom:1px solid #06C; font-weight:bold; padding:20px 15px; margin-left:10px; background-color:#FFF; height:40px;">
          <div style="font-size:15px; padding-bottom:8px;">EMPLOIS</div>
          <div>Mon Profil</div>
        </div>
        <div style="padding:20px 15px; margin-left:10px; background-color:#FFF;">
          <img src="img/emplois.jpg" />
        </div>
        <div style="padding:20px 15px; margin-left:10px; background-color:#FFF; border-top:1px solid #000; height:40px;">
          <div>Recevez tous les jours des offres correspondant à votre profil</div>
        </div>
        <div style="border-top:1px solid #666; margin:0 25%;"></div>
        <div style="padding:20px 15px; margin-left:10px; background-color:#FFF; height:40px;">
          <div>Cherchez un emploi plus efficacement.</div>
        </div>
        <div style="margin-left:10px; background-color:#FFF;">
            <input type="button" name="button" id="button" value="En SAVOIR +" style="background-color:#666; border:1px solid #666; color:#FFF; font-size:11px; padding:5px 25px;" />
        </div>
        <div style="padding:20px 8px; margin-left:10px; background-color:#FFF;">
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Présentation</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Comment ça marche ?</a></div>
          <div align="left" style="font-size:11px; padding:5px"><a href="#"><i class="icon-share-alt"></i> Souscrire au service</a></div>
        </div>
...
<div align="center" style="clear:both; margin-top:50px; padding-top:20px; background:url(img/_separe.png) center top no-repeat; font-size:14px;">
...
Faites votre choix. Nous sommes en soutien.<br /><br /><strong style="color:#F00;">Comment Souscrire ?  <a href="#">Cliquez ICI</a></strong>
</div>
