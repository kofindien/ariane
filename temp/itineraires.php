...
<title>Trajets ::: Navette Plus</title>
<!-- InstanceEndEditable -->
      ...
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:550px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div align="left" style="margin-bottom:30px; border-left:5px solid #03C; -webkit-border-radius:10px">
            	<div style="padding:5px 5px 5px 25px; <?php if (!isset($_GET['page'])) echo 'border-left:5px solid #0C0;';?>"><a href="itineraires.php">Ligne A</a></div>
            	<div style="padding:5px 5px 5px 25px; <?php if (isset($_GET['page']) && $_GET['page'] == 'ligneb') echo 'border-left:5px solid #0C0;';?>"><a href="itineraires.php?page=ligneb">Ligne B</a></div>
            	<div style="padding:5px 5px 5px 25px; <?php if (isset($_GET['page']) && $_GET['page'] == 'lignec') echo 'border-left:5px solid #0C0;';?>"><a href="itineraires.php?page=lignec">Ligne C</a></div>
            	<div style="padding:5px 5px 5px 25px; <?php if (isset($_GET['page']) && $_GET['page'] == 'controle') echo 'border-left:5px solid #0C0;';?>"><a href="itineraires.php?page=controle">Contrôles</a></div>
            </div>
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Trajets</div>

				<?php
                    // On d&eacute;finit le tableau contenant les pages autoris&eacute;es
                    // ----------------------------------------------------
                      $pageOK = array('ligneb' => 'trajets/ligneb.php',
					  				  'lignec' => 'trajets/lignec.php',
                                      'controle' => 'trajets/controle.php');
