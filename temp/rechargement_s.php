...
<title>Rechargements de cartes bancaires ::: Ariane</title>
<!-- InstanceEndEditable -->
   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      <div style="padding:15px;">
        <div style="padding:25px; border:1px solid #CCC; min-height:550px; background:#F9F9F9 url(images/fd.png) bottom center no-repeat; border-radius:8px; -webkit-border-radius:8px; -moz-border-radius:8px;">
          <div style="line-height:1.3em;">
            ...
            <div style="margin-left:260px;">
                ...
                <div class="titre" style="margin-bottom:20px; padding:10px 0;">Rechargements de cartes bancaires</div>
...
La carte Visa Prépayée UBA est une carte de retrait rechargeable qui vous offre une multitude de possibilités et son coût est très abordable. <br /><br />
Elle n'est pas rattachée à un compte bancaire, ce qui procure flexibilité et mobilité à ses utilisateurs.<br /><br />
La carte est utilisable dans le monde entier sur le réseau VISA.
            ...
            <div class="akordeon-item">
                ...
                <div class="akordeon-item-body">
                    <div class="akordeon-item-content">
                  <ul>
                    <li>Retrait d'espèces dans le monde entier, sur le réseau des guichets automatiques VISA ;
                    </li>
                    <li>Achats en magasin, sur les terminaux de paiements (TPE) ;</li>
                    <li>Achats sur Internet : Les achats sur Internet sont sécurisés par le système « verified by VISA ».</li>
                    <li>Transfert d'argent instantané d'une carte à l'autre sur le site www.myubaafricard.com
                     <ul>
                        <li>C'est une façon pratique d'envoyer des fonds à ses proches ou sa famille partout dans le monde.</li>
                      </ul>
                    </li>
                    ...
                    <li>Consultation du solde et des transactions effectuées :
                      <ul>
                        <li>Le site www.myubaafricard.com vous permet également de vérifier le solde de votre carte et de consulter le relevé de vos transactions. </li>
                      </ul>
                    </li>
                  </ul>
                  <br />Capacité de rechargement : 5.000.000 f CFA
                    </div>
                </div>
            </div>
            <div class="akordeon-item">
                ...
                <div class="akordeon-item-body">
                    ...
                    <ul>
                      <li> Utilisable immédiatement : dès le rechargement dans une agence UBA ou dans les points agréés ;
                      </li>
                      <li> Zéro frais de gestion mensuelle ;
                      </li>
                      <li> Disponibilité immédiate des fonds, en cas de réception d'un transfert sur carte, évitant ainsi les files d'attentes dans les banques ;
                      </li>
                      <li> Sécurité : la carte évite les risques liés au transport d'espèces (par exemple lors des voyages).
                      </li>
                    </ul>
                      <u>Pour les entreprises / organisations</u> :<br /><br />
                      <ul>
                      <li> Simplification de la gestion des paiements à des tiers (paies, frais de missions, primes, bourses, etc.) ;</li>
                      <li>Personnalisable selon vos besoins, la carte peut etre faconnée pour servir de carte d'abonné, de carte d'étudiant, etc.</li>
                    </ul>
                    </div>
                </div>
            </div>
            <div class="akordeon-item">
                ...
                <div class="akordeon-item-body">
                    <div class="akordeon-item-content">
        Il faut informer la banque immédiatement ou se rendre dans un point agréé pour faire opposition.
        <br /><br />
        Si vous commandez une nouvelle carte, les fonds disponibles sur l'ancienne carte seront transférés sur la nouvelle. <br />
        <br />
        E-mail d'urgence : ebanking-ci@ubagroup.com
                       </div>
                </div>
            </div>
            <div class="akordeon-item">
                <div class="akordeon-item-head">
                    <div class="akordeon-item-head-container">
                        <div class="akordeon-heading">
                            Que faire en cas de code erroné ?
                        </div>
                    </div>
                </div>
                <div class="akordeon-item-body">
                    <div class="akordeon-item-content">
                        Il faut se rendre dans nos points agréés pour une réédition de code. Cette réédition est gratuite.
                       </div>
                </div>
            </div>
            <div class="akordeon-item">
                <div class="akordeon-item-head">
                    <div class="akordeon-item-head-container">
                        <div class="akordeon-heading">
                           Pièces à fournir pour souscrire à la carte
                        </div>
                    </div>
                </div>
                <div class="akordeon-item-body">
                    <div class="akordeon-item-content">
                         <ul>
                      <li>La pièce d'identité</li>
                      <li>Le formulaire de souscription dûment rempli</li>
                    </ul>
                       </div>
                </div>
            </div>
