...
<title>Alerte Passagers AVION &raquo; Comment souscrire à Alerte Passagers AVION ?::: ESN ARIANE</title>
<!-- InstanceEndEditable -->
...
<div class="filariane" style="margin-bottom:20px; padding:10px 0;">Accueil / Alerte Passagers AVION / Comment souscrire à Alerte Passagers AVION ?</div>
				<div style="background: url(img/separe_.png) no-repeat; height:15px; padding-top:20px;"></div>

<div style="margin-bottom:20px;">
<img src="img/alerte1.jpg" /><br />
<br />
<strong>Alerte Passager AVIONS</strong> est un service qui est fourni via Internet. Il est fourni au moyen d'une plateforme d'échanges électroniques dénommé <strong>Espace de Services Numériques ARIANE</strong> ou <strong>ESN ARIANE</strong>. Pour souscrire à ce service, il faut donc obligatoirement sur le site d'ESN ARIANE qui est le <a href="http://www.ariane.ci">www.ariane.ci</a> et procéder comme indiqué ci-après.<br /><br />
La souscription à <strong>Alerte Passager AVIONS</strong> se fait en deux étapes successives :<br /><br />
<ul>
<li>Il faut d'abord créer un compte pour sécuriser les informations que vous allez communiquer sur votre vol et vous protéger contre des personnes malveillantes. Ce sera votre <strong>Compte Client ARIANE</strong>.</li><br />
<li>Ensuite, vous passerez à la souscription proprement dite pour utiliser le service de messagerie d'accompagnement personnalisé par SMS et per Email qu'est <strong>Alerte Passager AVIONS</strong>.</li>
</ul>
Ces deux étapes sont décrites ci-après.<br /><br /><br />
<div class="titre">Création de votre Compte Client ARIANE</div><br /><br />
<ol>
<li>Se rendre sur le site de la plateforme au moyen de laquelle ce service est fourni en allant sur le site <a href="http://www.ariane.ci">www.ariane.ci</a> afin d'ouvrir un compte de service ou Compte ARIANE.</li><br />
<li>Dans le menu, cliquer sur <strong>Alerte Passager AVIONS</strong>.</li>
<li>Cliquer ensuite sur le bouton <strong>Souscrire à Alerte Passagers AVION.</strong></li><br />
<li>Vous serez conduit à la page <strong>Création d'un compte Client</strong>. Remplissez le formulaire électronique qui apparaît et cliquez sur <strong>Soumettre</strong> pour envoyer votre demande de création de compte.</li><br />
<li>Vous allez recevoir par l'adresse email que vous avez indiqué les paramètres de votre <strong>Compte Client ARIANE</strong> et les instructions pour utiliser ce compte.</li>
</ol>

Votre Compte Client ARIANE est maintenant créé. Prenez soin de bien conserver votre mot de passe. Il vous permettra d'accéder à ce service chaque fois que vous en aurez besoin.<br /><br /><br />
<div class="titre">Souscription au service Alerte Passager AVIONS</div><br /><br />
Après avoir reçu votre mot de passe par Email, procéder comme suit :<br /><br />
<ol>
<li>Allez sur la plateforme ARIANE en tapant l'adresse de son site <a href="http://www.ariane.ci">www.ariane.ci</a></li><br />
<li>Allez à l'<strong>Espace Client</strong> en haut à droite sur la  page d'accueil et saisissez votre adresse Email et votre mot de passe.</li><br />
<li>Une fois que vous être entré dans l'Espace client, cliquez sur le bouton <strong>Alerte Passagers AVION</strong>.</li><br />
<li>Cliquez sur « <strong>Soumettre une demande d'alertes  voyages</strong> ».</li><br />
<li>Remplissez le formulaire qui apparaît en indiquant le numéro de vol et le jour de votre voyage.</li><br />
<li>Cliquez sur « <strong>Envoyer</strong> » pour terminer l'opération de souscription au service <strong>Alerte Passagers AVION</strong>.</li>
</ol>
<img src="img/al_accroche1.gif" />
</div>
            </div>
          </div>
        </div>
