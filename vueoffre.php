   ...
   <!-------------------- FLASH INFOS ------------------------------------->    
	...
	<!-- InstanceBeginEditable name="corps" -->
      ...
      <div>
            <ul class="pager">
              <li class="previous">
                <a href="offres.php">&larr; Précédent</a>
              </li>
            </ul>
      </div>

<div style="border-bottom:1px solid #CCC; padding-bottom:5px; margin-bottom:25px;">
<strong>Informations détaillées sur l'offre </strong>
</div>
  
<div style="padding:0 0 0 20px;">
				Date de publication de l'offre : <strong><?php echo dateEN2dateFR($row_rsOffre['datepub']); ?></strong><br /><br />
                Date d'expiration de l'offre : <strong><?php echo dateEN2dateFR($row_rsOffre['dateretrait']); ?></strong><br /><br />
                Source de l'offre : <strong><?php echo $row_rsOffre['source']; ?></strong><br /><br />
                Date de saisie de l'offre : <strong><?php echo LongDateEN2dateFR($row_rsOffre['dateaj']); ?></strong><br />
<br />
                Domaine de compétences : <strong><?php echo $row_rsOffre['domaine']; ?></strong><br /><br />
                Intitulé du poste : <strong><?php echo $row_rsOffre['intitulepost']; ?></strong><br /><br />
                Référence du poste : <strong><?php echo $row_rsOffre['ref']; ?></strong><br /><br />
                Contrat : <strong><?php echo $row_rsOffre['contrat']; ?></strong><br /><br />
                Société : <strong><?php echo $row_rsOffre['societe']; ?></strong><br /><br />
                Secteur d'activités : <strong><?php echo $row_rsOffre['sectactivite']; ?></strong><br /><br />
                Domaine d'expertise :<strong><?php echo $row_rsOffre['expertise']; ?></strong><br /><br />
                Nombre de postes à pourvoir : <strong><?php echo $row_rsOffre['nbposte']; ?></strong><br /><br />
                E-mail de soumission à l'offre : <strong><?php echo $row_rsOffre['email']; ?></strong><br /><br />
                Lien de l'offre :<a href="<?php echo $row_rsOffre['lien']; ?>" target="_blank" class="lien_bleu_"> <?php echo $row_rsOffre['lien']; ?></a>
                
                <br /><br />

                Diplôme : <strong><?php echo $row_rsOffre['diplome']; ?></strong><br /><br />
                Experience professionnelle : <strong><?php echo $row_rsOffre['experience']; ?></strong><br /><br />
                Age  exigé : <strong><?php echo $row_rsOffre['age']; ?></strong><br /><br />
                CV : <strong><?php echo $row_rsOffre['cv']; ?></strong><br /><br />
                Modèle  de dossier : <strong><?php echo $row_rsOffre['modeledos']; ?></strong><br /><br />
                Lettre de motivation : <strong><?php echo $row_rsOffre['courrier']; ?></strong><br /><br />
                Photocopie (légalisée) des diplômes  : <strong><?php echo $row_rsOffre['copie']; ?></strong><br /><br />
                Salaire : <strong><?php echo $row_rsOffre['salaire']; ?></strong><br /><br />
                Permis de conduire : <strong><?php echo $row_rsOffre['permis']; ?></strong><br /><br />
                Photo :<strong><?php echo $row_rsOffre['photo']; ?></strong>
</div>
                 
<div style="border-bottom:1px solid #CCC; padding-bottom:5px; margin:25px 0;">
<strong>Informations sur le recruteur </strong>
</div>

<div style="padding:0 0 0 20px;">
				Recruteur : <strong><?php echo $row_rsOffre['recruteur']; ?></strong><br /><br />
                Boîte postale : <strong><?php echo $row_rsOffre['bp']; ?></strong><br /><br />
                Adresse géographique : <strong><?php echo $row_rsOffre['adressegeo']; ?></strong><br /><br />
                Téléphone(s) :
                <strong>
                <?php 
                ...
                Fax : <strong><?php echo $row_rsOffre['fax']; ?></strong><br /><br />
                E-mail : <strong><?php echo $row_rsOffre['emailr']; ?></strong><br /><br />
